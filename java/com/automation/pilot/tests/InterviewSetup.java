...
public class InterviewSetup extends TestBaseClass {
	...
	String jobId = Integer.toString(randomNum);
	String jobToSelect;
	...
	public void verifyInterviewSetupFromPeoplesTab() throws InterruptedException {
//		intvrDetails.add(new_IntvTeam);
		Applib.refreshPage();
		...
		peoplesTab.createANewPeopleAndMoveForward(fName, lName, jobToSelect);
		peoplesTab.selectATabForCandidate(tab_Intv);
		peoplesTab.verifyInterviewSetUpInPeoplesTab(intvrDetails, durationToCheck, phNum);
		Assertion.assertAll();
	}
	 ...
	 */
	@Test(alwaysRun = true, enabled = true, dependsOnMethods = {
			"verifyInterviewSetupFromPeoplesTab" }, description = "verify Interview setup from Peoples Tab")
